...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
         ...
         user_profile.profile_picture = 'default/user_avatar.png'
         user_profile.save()
         ...
         send_email.send()
         #messages.success(request, 'Your registration has been successful. Please check your email address we have sent you verification link. Please verify it.')
...
def activate(request, uidb64, token):
    ...
    if user is not None and default_token_generator.check_token(user, token):
            user.is_active = True
            user.save()
            messages.success(request, 'Congratulations, your account have been successfully activated.')
            return redirect('login')
